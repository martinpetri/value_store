...
class ValuesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create value" do
    assert_difference('Value.count') do
      post values_url, params: { value: { measured_at: @value.measured_at, topic_id: @value.topic_id, value: @value.value } }
    end
  ...
  test "should update value" do
    patch value_url(@value), params: { value: { measured_at: @value.measured_at, topic_id: @value.topic_id, value: @value.value } }
